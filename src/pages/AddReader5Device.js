...
navigate("/home-device-5-connected-ready")
  ...
  const getConnectingDeviceNumber = () => {
    if (
      deviceconnect.device1 &&
      !(deviceconnect.device2 || deviceconnect.device3 || deviceconnect.device4)
    )
      return 2;
    if (
      deviceconnect.device1 &&
      deviceconnect.device2 &&
      !(deviceconnect.device3 || deviceconnect.device4)
    )
      return 3;
    if (
      deviceconnect.device1 &&
      ...
      <div className={styles.bodyScreen}>
        <div className={styles.frameParent}>
          ...
          <div className={styles.addDevice4Parent}>
            <b className={styles.addDevice4}>
              ADD DEVICE #{getConnectingDeviceNumber()}
            </b>
