...
//   const deviceconnectTest = useSelector((state)=>state.AddDeviceDetails.deviceTest)
...
//   if (deviceconnectTest.device1&&!(deviceconnectTest.device2||deviceconnectTest.device3||deviceconnectTest.device4)) return 1;
//   if (deviceconnectTest.device2&&!(deviceconnectTest.device1||deviceconnectTest.device3||deviceconnectTest.device4)) return 2;
//   if (deviceconnectTest.device3&&!(deviceconnectTest.device1||deviceconnectTest.device2||deviceconnectTest.device4)) return 3;
//   if (deviceconnectTest.device4 &&!(deviceconnectTest.device1||deviceconnectTest.device2||deviceconnectTest.device3)) return 4;
//   // return 5;
// };
//   return (
...
//            {!deviceconnectTest.device1&&deviceconnect.device1&& <div className={styles.frameWrapper}>
...
//               </div>
//             </div>}
//            { !deviceconnectTest.device2&&deviceconnect.device2&& <div className={styles.frameWrapper}>
//               <div className={styles.parent}>
...
//           </div>
//           <div className={styles.frameGroup}>
//             { !deviceconnectTest.device3&&deviceconnect.device3&& <div className={styles.frameWrapper}>
//               <div className={styles.parent}>
...
//               </div>
//             </div>}
//            { !deviceconnectTest.device4&&deviceconnect.device4&&  <div className={styles.frameWrapper}>
//               <div className={styles.parent}>
